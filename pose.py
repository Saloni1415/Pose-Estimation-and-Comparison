...
class Pose(object):
	...
	def getpoints(self,image_input,sess,model_cfg,model_outputs):
		...
		print("length======",len(pose_scores))
		print("pose sscroes",pose_scores)
	...
	def getpoints_vis(self,image_input,sess,model_cfg,model_outputs,frame_count):
		sum = 0
		pos_temp_data=[]
		output_stride = model_cfg['output_stride']
		...
		overlay_image = posenet.draw_skel_and_kp(1,
	...
	def roi(self,imagepoints):
		...
		# print("coords_new_reshaped======",coords_new_reshaped)
		coords_new_reshaped= np.asarray(coords_new_reshaped)
		# print("coords_new_reshaped new======",coords_new_reshaped)
		coords_new = np.asarray(coords_new_reshaped).reshape(17,2)
		# print("coords_new=====",coords_new)
